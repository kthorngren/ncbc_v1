...
'075-circle-LP':{'paper-size':'letter','metric':'mm','marginLeft':14.0, 'marginTop':12.0, 'NX':9, 'NY':12, 'SpaceX':1.7, 'SpaceY':2.0, 'width':19.05, 'height':19.05,'font-size':8},
'050-circle-old':{'paper-size':'letter','metric':'mm','marginLeft':26.0, 'marginTop':20.0, 'NX':9, 'NY':12, 'SpaceX':5.0, 'SpaceY':5.0, 'width':14.0, 'height':14.0,'font-size':4},
'050-circle':{'paper-size':'letter','metric':'mm','marginLeft':17.0, 'marginTop':17.0, 'NX':9, 'NY':12, 'SpaceX':6.5, 'SpaceY':6.5, 'width':14.0, 'height':14.0,'font-size':4},
}
...
class PDFLabel(FPDF):
    ...
    def __init__(self,format, unit='mm',posX=1,posY=1, font=None, font_size=None):
        ...
        self.line_height = self.get_height_chars(font_size if font_size else type_format['font-size']) # Line height
        self.set_font_size(font_size if font_size else type_format['font-size'])
        self.padding = self.convert_metric(3, 'mm')  # padding

        self.set_font(font if font else 'Arial')
